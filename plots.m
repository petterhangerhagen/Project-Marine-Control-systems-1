...
subplot(3,1,1);
hold on;
plot(tout,pos.data(:,1),"k",LineWidth=1,Displayname="position")
...
subplot(3,1,2);
hold on;
plot(tout,pos.data(:,2),"k",LineWidth=1,Displayname="position")
...
subplot(3,1,3);
hold on;
plot(tout,pos.data(:,3),"k",LineWidth=1,Displayname="angle");
